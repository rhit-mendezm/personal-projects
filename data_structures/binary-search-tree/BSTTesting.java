...
// Uncomment when you are ready to test.
	...
	@Test
	public void testInsertInBSTOfStrings() {
	...
	public void testInsertReturnValue() {
		...
		b.insert(2);
		b.insert(5);
		assertFalse("Expected: false", b.insert(5));
		assertTrue("Expected: true", b.insert(1));
		points += 4;
	}
	...
	public void testContains() {
		...
		b.insert(5);
		// assertEquals("[2, 4, 5, 7, 10]", b.toString());
		assertFalse("Expected: false", b.contains(1));
		assertTrue("Expected: true", b.contains(2));
		points += 1;
		assertFalse("Expected: false", b.contains(3));
		assertTrue("Expected: true", b.contains(4));
		points += 1;
		assertTrue("Expected: true", b.contains(5));
		assertTrue("Expected: true", b.contains(7));
		points += 1;
		assertTrue("Expected: true", b.contains(10));
		assertFalse("Expected: false", b.contains(11));
		points += 1;
	}

	@Test
	public void testContainsInBSTOfStrings() {
		BinarySearchTree<String> b = new BinarySearchTree<String>();
		b.insert("green");
		b.insert("blue");
		b.insert("red");
		...
		b.insert("yellow");
		assertEquals("[blue, green, orange, red, yellow]", b.toString());
		assertFalse("Expected: false", b.contains("purple"));
		assertTrue("Expected: true", b.contains("green"));
		points += 1;
		assertFalse("Expected: false", b.contains("fucsia"));
		assertTrue("Expected: true", b.contains("blue"));
		points += 1;
		assertTrue("Expected: true", b.contains("red"));
		assertTrue("Expected: true", b.contains("yellow"));
		points += 1;
		assertTrue("Expected: true", b.contains("orange"));
		assertFalse("Expected: false", b.contains("turquoise"));
		points += 1;
	}
	...
	public void testRemove() {
		...
		Iterator<Integer> iter = b.preOrderIterator();
		assertTrue("Expected: true", iter.hasNext());
	...
	public void testRemoveReturnValue() {
		...
		assertFalse("Expected: false", b.remove(7));
		points += 1;

		// remove just root
		b.insert(4);
		assertTrue("Expected: true", b.remove(4));
		assertEquals("[]", b.toString());
		points += 1;
		...
		b.insert(4);
		b.insert(14);
		assertTrue("Expected: true", b.remove(14));
		points += 1;
		Integer[] a = { 10, 4 };
		boolean[] bool = { true, false };
		Iterator<Integer> iter = b.preOrderIterator();
		...
		// remove root in simple tree
		b.insert(4);
		assertTrue("Expected: true", b.remove(10));
		a[0] = 4;
		a[1] = 14;
		iter = b.preOrderIterator();
		assertTrue("Expected: true", iter.hasNext());
	...
	public void testEfficiency() {
		...
		System.out.printf(
				"Note: in our solution, n = 1000000 usually has a height of ~50, or ~2.5*log(1000000) after random inserts.\n");
		System.out.printf("If yours is much bigger, you should check your insert.\n");
		System.out.printf(
				"If this method takes longer than a couple seconds to run, you should also check your insert.\n");
		// Quick sanity check: is height < 4* log_2(n) (this is a good buffer)
		assertTrue("Expected: true", height < 4 * Math.log(size) / Math.log(2));
	}
